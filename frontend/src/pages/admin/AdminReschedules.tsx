      ...
      {loading ? (
        ...
        <div className="glass-card overflow-auto">
          <div className="flex justify-end border-b border-white/5 px-3 py-2">
            <button onClick={load} disabled={loading} aria-label="Refresh reschedule requests" title="Refresh table data" className="p-2 text-slate-400 hover:text-white hover:bg-white/10 rounded-lg transition-colors disabled:cursor-not-allowed disabled:opacity-50">
